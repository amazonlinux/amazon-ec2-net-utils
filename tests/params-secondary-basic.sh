...
# Test a secondary interface (i.e. not eth0) with a single local IPv4 address
...
dhclient6_env_up() {
    new_ip6_address=fd01:ffff:eeee:dddd:4:3:2:1
    interface=eth1
